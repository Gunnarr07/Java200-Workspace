...
public class JavaFXEventDemo extends Application {
	...
	public void start(Stage myStage) {
		...
		// Create a scene.
		Scene myScene = new Scene(rootNode, 1000, 800);
		myScene.getStylesheets().add("./desktop/application/Styles.css");
		...
		// Crate two push buttons.
		Button btnAlpha = new Button("Alpha");
		btnAlpha.getStyleClass().add("button1");
